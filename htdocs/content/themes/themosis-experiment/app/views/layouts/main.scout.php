    ...
    <section id="courses-banner-large">
        <div class="row">
            ...
            <div class="large-7 medium-7 columns banner-info">
                ...
                <p>Learn the fundamentals of the world's most advanced responsive framework in our <strong>Intro to
                        Foundation class.</strong> You'll learn from the creators themselves on how to use Foundation
                    and jumpstart your next project. <a href="http://zurb.com/university/courses" class="inline-hide">Learn
                        more about classes »</a></p>
                <a href="http://zurb.com/university/foundation-intro?utm_source=Foundation%20Docs&utm_medium=Large%20Banner&utm_campaign=Intro%20to%20Foundation"
                   class="button">Learn More</a>
                <a href="http://zurb.com/university/courses" class="learn-more hide-for-medium-up">Learn more about
                    classes »</a>
            </div>
        </div>
    </section>
    <div id="newsletter">
        <div class="row">
            <div class="medium-8 columns">
                ...
                <p>Sign up to receive monthly Responsive Reading highlights. <a
                        href="http://zurb.com/responsive/reading">Read Last Month's Edition »</a></p>
            </div>
            <div class="medium-4 columns">
                <form action="http://zurb.createsend.com/t/y/s/xlitlu/" method="post" id="subForm">
                    <div class="row collapse margintop-20px">
                        <div class="small-8 medium-8 columns">
                            <input id="fieldEmail" name="cm-xlitlu-xlitlu" type="email"
        ...
        <div class="row property">
            <div class="medium-4 columns">
                <div class="property-info">
                    ...
                    <p>Foundation is a responsive front-end framework made by <a href="http://zurb.com">ZURB</a>, a
                        product design company in Campbell, CA. This framework is the result of building web products
                        &amp; services since 1998.
                    </p>
                </div>
            </div>
                ...
                <div class="row collapse">
                    ...
                    <div class="medium-4 columns">
                        <div class="support-links">
                            ...
                            <p><a href="http://foundation.zurb.com/business/business-support.html">Business Support</a>
                            </p>

                            <p>Or check our <a href="http://foundation.zurb.com/support/support.html">support page</a>
                            </p>
                        </div>
                    </div>
                    <div class="medium-4 columns">
                        <div class="connect-links">
                            ...
                            <p>Keep up with the latest on Foundation. Find us on <a
                                    href="https://github.com/zurb/foundation">Github</a>.</p>
        ...
        <div class="row">
            ...
            <div class="medium-8 medium-8 pull-4 columns">
                ...
                <ul class="zurb-links">
                    ...
                    <li><a href="http://zurb.com/news">News<span class="show-for-medium-up"> &amp; Events</span></a>
                    </li>
