...
<nav>
    <ul class="side-nav">
        ...
        <li><a href="../sass-files.html" data-search="Sass,Sass - What You Get, How to Use Sass">Sass
                Files</a></li>
        <li><a href="../using-sass.html" data-search="Sass,Sass - What You Get, How to Use Sass">Using
                Sass</a></li>
        ...
        <li><a href="global.html"
               data-search="Global Styles,Global Mixins,Global Variables,Useful HTML Classes">Global
                Styles</a></li>
        ...
        <li><a href="interchange.html" data-search="Responsive Images">Interchange Responsive
                Content <span class="label">JS</span></a></li>
        ...
        <li><a href="offcanvas.html" data-search="Off Canvas">Off-canvas <span
                    class="label">JS</span></a></li>
        <li><a href="topbar.html" data-search="Nav Bar,Navigation,Sticky">Top Bar <span
                    class="label">JS</span></a></li>
        <li><a href="icon-bar.html" data-search="">Icon Bar</a></li>
        <li><a href="sidenav.html" data-search="">Side Nav</a></li>
        <li><a href="magellan.html" data-search="Scrollspy">Magellan Sticky Nav <span class="label">JS</span></a>
        </li>
        <li><a href="subnav.html" data-search="">Sub Nav</a></li>
        <li><a href="breadcrumbs.html" data-search="Navigation Path,Cookie Crumb">Breadcrumbs</a>
        </li>
        <li><a href="pagination.html" data-search="">Pagination</a></li>

        <li class="divider"></li>
        <li class="heading">Media</li>
        <li><a href="orbit.html" data-search="Carousel,Slider,Slideshow">Orbit Slider <span
                    class="label">JS</span></a></li>
        <li><a href="thumbnails.html" data-search="Images">Thumbnails</a></li>
        <li><a href="clearing.html" data-search="Responsive Lightbox,Lightbox">Clearing Lightbox
                <span class="label">JS</span></a></li>
        ...
        <li><a href="range_slider.html" data-search="Range Slider">Range Sliders <span
                    class="label">JS</span></a></li>
        <li><a href="abide.html" data-search="Form Validation,Field Validation">Abide Validation
                <span class="label">JS</span></a></li>
        ...
        <li><a href="split_buttons.html" data-search="">Split Buttons <span class="label">JS</span></a>
        </li>
        <li><a href="dropdown_buttons.html" data-search="">Dropdown Buttons <span
                    class="label">JS</span></a></li>

        <li class="divider"></li>
        <li class="heading">Typography</li>
        <li><a href="typography.html" data-search="Typography,Type-setting,Composition">Type</a>
        </li>
        ...
        <li><a href="reveal.html" data-search="Modal">Reveal Modal <span class="label">JS</span></a>
        </li>
        <li><a href="alert_boxes.html" data-search="Error,Success,Warning">Alerts <span
                    class="label">JS</span></a></li>
        <li><a href="panels.html" data-search="Wells">Panels</a></li>
        <li><a href="tooltips.html" data-search="Popover">Tooltips <span class="label">JS</span></a>
        </li>
        <li><a href="joyride.html" data-search="Tooltip Tour,Guider,Tooltip Walk-through">Joyride
                <span class="label">JS</span></a></li>
